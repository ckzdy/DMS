...
{12,4146,1,0,0,
5,0,0,1,0,0,27,41,0,0,4,4,0,1,0,1,97,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,0,0,30,54,0,0,0,0,0,1,0,
51,0,0,3,151,0,3,83,0,0,6,6,0,1,0,1,97,0,0,1,97,0,0,1,3,0,0,1,97,0,0,1,97,0,0,
1,3,0,0,
90,0,0,4,0,0,29,97,0,0,0,0,0,1,0,
};


/*
 -- 创建表
 create table dmslog_xxx(
...

{
 ...
 sqlstm.sqhstv[0] = (         void  *)g_userpasswd;
...
void OracleDao::insert(MLogRec const& log) throw (DBException)
{
	...
	/* exec sql insert into dmslog_zsm_00 values(
	    dmslog_id_zsm_00.nextval,
		:g_log.logname,
		:g_log.logip,
		:g_log.pid,
...

{
 ...
 sqlstm.sqladtp = &sqladt;
 sqlstm.sqltdsp = &sqltds;
 sqlstm.stmt = "insert into dmslog_zsm_00  values (dmslog_id_zsm_00.nextval \
,:b0,:b1,:b2,to_date(:b3,'yyyy-mm-dd hh24:mi:ss'),to_date(:b4,'yyyy-mm-dd hh24\
:mi:ss'),:b5)";
 sqlstm.iters = (unsigned int  )1;
